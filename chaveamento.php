...
<!--form method='POST' action= "">
    ...
    <!?php
     ...
     /* foreach ($chaveamento as $chave) {
       // echo '<div>' . $chave['participante1'] . '<div>';
        ...
        echo '<section class="Esquerda">
        
            <div class="combate">
                <div class="atleta1">' . $chave['participante1'] . '</div>
            </div>
        </section>
        ...
        <section class="Direita">
            ...
            <div class="combate">
                <div class="atleta2">' . $chave['participante2'] . '</div>
            </div>
        </section>';
    }*/
    ...
    <main class="main">
            <section class="Esquerda">                
                <article class="q-final">
                    <section>
                        <div class="q-div">
                            <div class="atleta-div"> 1 </div> 
                            <div class="atleta-div"> 2  </div>
                        </div>
    ...
    <div class="ganhador">
        <div class="quemganhou">
            <img src="imgs/trofeu.png" alt="troféu dourado">
        </div>
